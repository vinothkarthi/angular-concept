...
import { canActivateChildGuard, canActivateGuard, canDeactivateGuard, delayResolver, resolveGuard } from './guard/auth-guard.guard';
...
export const routes: Routes = [
  ...
  {path:'user',component: UserComponent,canActivateChild:[canActivateChildGuard], children: [
    {
      path: 'hostlistener',component: PostComponent, resolve: {resolvedData:resolveGuard}
    },{
      path: 'store',component: PersonalComponent, canDeactivate:[canDeactivateGuard]
    }
  ]},
  {path:'observable',component: ObservableSubjectComponent, canActivate:  [canActivateGuard]},
